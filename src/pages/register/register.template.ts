...
<div class="register-page">
  <form class="register-page__wrapper">
    ...
    <div class="register-page__input-wrapper">
                        {{{ 
                           InputWithLabel
                              classInput="input-with-label__input"
                              labelText="Почта" errorText="Латиница, обязательно должен быть символ @"
                              inputType="email"
                              inputId="email"
                              inputName="email" 
                              regexp="${REGEXP_EMAIL}" 
                        ...
                        {{{ 
                            InputWithLabel 
                                classInput="input-with-label__input" 
                                labelText="Логин" 
                                errorText="Должно содержать от 3 до 8 символов" 
                                inputId="login" 
                                inputType="text" 
                                inputName="login" 
                                regexp="${REGEXP_LOGIN}" 
                        ...
                        {{{ 
                            InputWithLabel 
                                classInput="input-with-label__input" 
                                labelText="Телефон" errorText="Цифры, от 11 до 15 символов" 
                                inputId="phone" 
                                inputType="tel" 
                                inputName="phone" 
                                regexp="${REGEXP_PHONE}" 
                        ...
                        {{{ 
                            InputWithLabel 
                                classInput="input-with-label__input" 
                                labelText="Пароль" 
                                errorText="Должно содержать от 8 до 40 символов + Заглавный символ" 
                                inputId="password" 
                                inputType="password" 
                                inputName="password" 
